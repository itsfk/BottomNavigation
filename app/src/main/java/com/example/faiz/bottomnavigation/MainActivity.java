package com.example.faiz.bottomnavigation;
...
import static com.example.faiz.bottomnavigation.R.id.text;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void selectFragment(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_super:
                frag = MenuFragment.newInstance(getString(R.string.text_super),
                        getColorFromRes(R.color.color_super));
